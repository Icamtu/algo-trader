...
class SimulatedOrderManager(OrderManager):
    ...
    def __init__(self, risk_manager: Any = None, mode: str = "paper"):
        ...
        self.slippage_pct = 0.0005 # 0.05% per trade
    ...
    async def place_order(
        ...
        **kwargs
        ...
        logger.info(f"[{self.mode.upper()}_FILL] {action} {quantity} {symbol} @ ₹{fill_price:.2f} (Strat: {strategy_name})")
