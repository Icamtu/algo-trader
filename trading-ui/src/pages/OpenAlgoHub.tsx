...
export default function OpenAlgoHub() {
  ...
  const coreModules = [
    ...
    { to: "/openalgo/strategy-registry", icon: Cpu, label: "Strategy_Registry", desc: "Central_Command for all trading cores.", color: secondaryColor, bg: secondaryBg },
    ...
    { to: "/openalgo/holdings", icon: ShieldCheck, label: "Asset_Vault", desc: "Long-term inventory audit.", color: primaryColor, bg: primaryBg },
  ];
  ...
  const strategyLabs = [
    { to: "/openalgo/max-pain", icon: Target, label: "Max_Pain_Lab", desc: "Strike-wise pain index audit.", color: secondaryColor, bg: secondaryBg },
    { to: "/openalgo/straddle-lab", icon: Layers, label: "Straddle_Lab", desc: "Synthetic future & premium tracking.", color: primaryColor, bg: primaryBg },
