...
export function BrokerManagementPanel({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  ...
                  <div key={field.key} className="glass-panel rounded-md p-2.5">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        onChange={() => setConfigModified(true)}
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-border">
              <button className="glow-button rounded-md px-4 py-2 text-xs font-semibold text-primary-foreground">
                Save Configuration
              </button>
              <button
