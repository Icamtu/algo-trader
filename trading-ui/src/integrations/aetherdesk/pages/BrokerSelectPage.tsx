  ...
  const handleConnect = () => {
    ...
    switch (selectedBroker) {
      ...
      case 'upstox':
        ...
        break;
      case 'fyers':
        loginUrl = `https://api-t1.fyers.in/api/v3/generate-authcode?client_id=${broker_api_key}&redirect_uri=${redirect_url}&response_type=code&state=aetherdesk_v4`;
        break;
      default:
  ...
  return (
    <div className="h-full flex flex-col p-6 space-y-6 bg-background overflow-hidden font-mono">
       ...
       <div className="mt-12 flex justify-center gap-8">
          <a href="https://docs.aetherdesk.in" target="_blank" rel="noreferrer" className={cn("flex items-center gap-2 text-[9px] font-mono transition-colors uppercase tracking-widest opacity-40 hover:opacity-100", primaryColorClass)}>
