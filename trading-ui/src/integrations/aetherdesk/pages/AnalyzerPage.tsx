...
export const AnalyzerPage: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col p-6 space-y-6 bg-background overflow-hidden font-mono">
       ...
       {/* Control Deck */}
       <AetherPanel className="border-border/10 bg-background/40 shrink-0">
       ...
       {/* Telemetry Stats */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 shrink-0">
           {[
             ...
             { label: "Anomaly_Detected", value: stats.issues?.total || 0, icon: AlertTriangle, color: "text-rose-500" },
       ...
       {/* Request Stream */}
        <AetherPanel className="p-0 border-border/10 overflow-hidden min-h-[400px] md:min-h-[600px] flex-1 bg-background/20">
           <div className="p-6 border-b border-border/10 flex justify-between items-center bg-foreground/5 shrink-0">
