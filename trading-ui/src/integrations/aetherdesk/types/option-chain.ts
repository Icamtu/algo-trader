...
export const COLUMN_DEFINITIONS: ColumnDefinition[] = [
  ...
  { key: 'ce_delta', label: 'Delta', side: 'ce', width: 'w-14', align: 'right', defaultVisible: false, formatter: 'price' },
  { key: 'ce_gamma', label: 'Gamma', side: 'ce', width: 'w-14', align: 'right', defaultVisible: false, formatter: 'price' },
  { key: 'ce_theta', label: 'Theta', side: 'ce', width: 'w-14', align: 'right', defaultVisible: false, formatter: 'price' },
  { key: 'ce_vega', label: 'Vega', side: 'ce', width: 'w-14', align: 'right', defaultVisible: false, formatter: 'price' },
  { key: 'ce_iv', label: 'IV', side: 'ce', width: 'w-14', align: 'right', defaultVisible: true, formatter: 'price' },
  // Center column
  ...
  { key: 'pe_iv', label: 'IV', side: 'pe', width: 'w-14', align: 'left', defaultVisible: true, formatter: 'price' },
  { key: 'pe_delta', label: 'Delta', side: 'pe', width: 'w-14', align: 'left', defaultVisible: false, formatter: 'price' },
  { key: 'pe_gamma', label: 'Gamma', side: 'pe', width: 'w-14', align: 'left', defaultVisible: false, formatter: 'price' },
  { key: 'pe_theta', label: 'Theta', side: 'pe', width: 'w-14', align: 'left', defaultVisible: false, formatter: 'price' },
  { key: 'pe_vega', label: 'Vega', side: 'pe', width: 'w-14', align: 'left', defaultVisible: false, formatter: 'price' },
...
export const LOCALSTORAGE_KEY = 'aetherdesk_option_chain_prefs'
